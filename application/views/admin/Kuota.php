  ...
  <div class="row">
    <div class="col">
      <div class="card">
        ...
        <a class="btn btn-link" href="<?= base_url('Kuota/halaman_tambah'); ?>" role="button">Tambah Data Kuota
          Petani</a>
      </div>
    </div>
  </div>
    ...
    <div class="col">
      <div class="card bg-primary shadow">
        <div class="card-header bg-transparent border-0">
          ...
          <h3 class="text-white mb-0">Daftar Kuota Petani</h3>
        </div>
              ...
              foreach ($queryAllKuota as $row) {
                ...
                <tr>
                  ...
                  <td class="text-white mb-0"><a class="text-white mb-0"
                      href="<?= base_url('Kuota/halaman_edit'); ?>/<?php echo $row->id ?>">Edit</a> | <a
                      class="text-white mb-0"
                      href="<?= base_url('Kuota/fungsidelete'); ?>/<?php echo $row->id ?>">Delete</a></td>
                </tr>
              <?php } ?>
            </thead>
            </tbody>
