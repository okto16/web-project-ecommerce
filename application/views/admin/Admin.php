    ...
    <div class="row">
      <div class="col">
        <div class="card">
          ...
          <a class="btn btn-link" href="<?= base_url('Admin/halaman_tambah'); ?>" role="button">Tambah Admin</a>
        </div>
      </div>
    </div>
    <!-- Dark table -->
          ...
          <div class="table-responsive">
            <table class="table align-items-center bg-primary table-flush">
              <thead class="thead-light">
                <tr>
                  <th scope="col" class="sort" data-sort="name">Id Admin</th>
                ...
                ?>
                  <tr>
                    <td class="text-white mb-0"><?php echo $row->idAdmin ?></td>
                    ...
                    <td class="text-white mb-0"><a class="text-white mb-0" href="<?= base_url('Admin/halaman_edit'); ?>/<?php echo $row->idAdmin ?>">Edit</a> | <a class="text-white mb-0" href="<?= base_url('Admin/fungsidelete'); ?>/<?php echo $row->idAdmin ?>">Delete</a></td>
                  </tr>
                <?php } ?>
              </thead>
              </tbody>
