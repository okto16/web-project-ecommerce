<?php foreach ($rows as $row) : ?>
    <li><?= $row->namaKonsumen; ?></li> <!-- Ganti 'judul' dengan kolom yang ingin ditampilkan -->
<?php endforeach; ?>
<!-- Header -->
<!-- Header -->
<!-- Page content -->
                ...
                <div class="table-responsive">
                    <table class="table align-items-center bg-primary table-flush">
                        <thead class="thead-light">
                            <tr>
                                <th scope="col" class="sort" data-sort="name">Id Konsumen</th>
                                <th scope="col" class="sort" data-sort="name">NIK</th>
                                <th scope="col" class="sort" data-sort="name">Username</th>
                                <th scope="col" class="sort" data-sort="completion">Nama Konsumen</th>
                            ...
                            <?php foreach ($results as $row) : ?>
                                <tr>
                                    ...
                                    <td class="text-white mb-0"><a class="text-white mb-0" href="<?= base_url('Member/halaman_edit'); ?>/<?php echo $row->username ?>">Edit</a> | <a class="text-white mb-0" href="<?= base_url('Member/fungsidelete'); ?>/<?php echo $row->username ?>">Delete</a></td>
                                </tr>
                            <?php endforeach; ?>
                        </thead>
                        </tbody>
