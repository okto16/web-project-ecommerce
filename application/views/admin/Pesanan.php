          ...
          <div class="col">
            <div class="card bg-primary shadow">
              <div class="card-header bg-transparent border-0">
                ...
                <h3 class="text-white mb-0">Data Pesanan</h3>
              </div>
                    ...
                    foreach ($invoice as $row) {
                      ...
                      <tr>
                        ...
                        <td class="text-white mb-0"><a class="text-white mb-0"
                            href="<?= base_url('Pesanan/approve/' . $row->idInvoice) ?>">Konfirmasi</a> | <a
                            class="text-white mb-0" href="<?= base_url('Pesanan/ditolak/' . $row->idInvoice) ?>">Tolak</a>
                          | <a class="text-white mb-0"
                            href="<?= site_url('Pesanan/detail/' . $row->idInvoice) ?>">Detail</a></td>
                      </tr>
                    <?php } ?>
                  </thead>
                  </tbody>
