                    ...
                    <table class="table align-items-center bg-primary table-flush">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col" class="sort" data-sort="completion">Bukti Transfer</th>
                            ...
                            <?php foreach ($results as $row) : ?>
                                <tr>
                                    ...
                                    <td class="text-white mb-0"><img src="<?= base_url('assets/img/' . $row->bukti_transfer); ?>" width="50"></td>
                                    <td class="text-white mb-0"><?php echo $row->total_harga ?></td>
                                    <td class="text-white mb-0"><?php echo $row->tgl_pesan ?></td>
                                    <td class="text-white mb-0"><a class="text-white mb-0" href="<?= base_url('Pesanan/approve/' . $row->idInvoice) ?>">Konfirmasi</a> | <a class="text-white mb-0" href="<?= site_url('Pesanan/detail/' . $row->idInvoice) ?>">Detail</a></td>
                                </tr>
                            <?php endforeach; ?>
                        </thead>
                        </tbody>
